...
<head>
  ...
  <title>Editing Exam Mark | Lilongwe Private School</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editing <?php echo $student['firstname']." ".$student['lastname']."'s"; ?> Exam Mark
       
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Editing Exam Mark</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-body">
            <form action="exam-mark-edited.php" method="POST">
        ...
        <input type="text" hidden="" id="student_no" value="<?php echo $_POST['student_no']; ?>" name="student_no">

            <!-- Start of the variables to passed on to the next page -->
         <input type="text" hidden="" name="settings_id" value="<?php echo$_POST['settings_id']; ?>">
