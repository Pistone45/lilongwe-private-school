...
if(isset($_POST['submit'])){
	...
	//validate  file
	 ...
	 $addService->addService($image_Path,$title,$content,$icon);
...
<head>
  ...
  <title>Add Service | Click Mobile</title>
        ...
        <div class="col-md-6">
          <!-- general form elements -->
              <div class="box-body">
				...
				<div class="form-group">
                  <label for="Icon">Service Icon (atleast 100px)</label>
                  <input type="file" class="" name="icon_image" required>
                </div>
