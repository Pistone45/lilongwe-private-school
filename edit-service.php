...
<head>
  ...
  <title>Edit Service | Click Mobile</title>
          ...
          <!-- general form elements -->
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input class="form-control" name="title" value="<?php echo $service['name'];   ?>" required>
                </div>
				...
				<div class="form-group">
                  ...
                  <textarea class="form-control" name="content" required><?php echo $service['description'];   ?></textarea>
                </div>
