...
$getFinalAssignmentMarkPerGuardian = new Staff();
$FinamMarks = $getFinalAssignmentMarkPerGuardian->getFinalAssignmentMarkPerGuardian($academic_year, $term, $student_no);

$getTrialMarkPerGuardian = new Staff();
$mark = $getTrialMarkPerGuardian->getTrialMarkPerGuardian($academic_year, $term, $student_no);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Final Results for <?php echo $student['name']; ?>
