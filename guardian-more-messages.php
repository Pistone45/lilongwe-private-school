...
$getReadMessagesPerGuardian = new Guardian();
$readmessages = $getReadMessagesPerGuardian->getReadMessagesPerGuardian($id);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Messages for <?php echo $student['name']; ?> <a href="guardian-select-student"><button class="btn btn-info">Switch Student</button></a>
      </h1>
      <ol class="breadcrumb">
