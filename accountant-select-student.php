    ...
    ?>
        ...
        $i = 0;
            ...
            $i++;   ?>
                  ...
                  <td><?php if($student['amount'] > 0){ ?>     <button type="button" class="btn btn-warning disabled" data-toggle="popover" title="Fees for this Student Already Recorded" data-content="The last popover!">Already Recorded</button> <?php } else{  ?> <button type="button" class="btn btn-success" data-toggle="modal" data-target="#<?php echo $i; ?>">Record Fees</button> <?php } ?></td>
                                          <!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Record Fees:</h4>
      </div>
