...
<head>
  ...
  <title>View Guardians | Lilongwe Private School</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="view-guardian.php">Guardian Details</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="box-header with-border">
              <a href="add-guardian.php"><button type="submit" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add Guardian Details</button></a>
            </div>
          <div class="box">
