...
<head>
  ...
  <title>Editing Assignment Mark | Lilongwe Private School</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editing <?php echo $student['firstname']." ".$student['lastname']."'s"; ?> Assignment Mark
       
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><a href="#">Assigning Assignment Mark</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-body">
            <form action="mark-edited.php" method="POST">

            <div class="form-group">
              <label for="exampleInputEmail1">Mark</label>
              <input type="number" name="mark" max="15" required="" class="form-control" id="" aria-describedby="emailHelp" placeholder="Enter Marks">
              <small id="emailHelp" class="form-text text-muted">Decimals can also be added</small>
            </div>
        <input type="text" hidden="" id="assignments_id" value="<?php echo $_POST['assignments_id']; ?>" name="assignments_id">
        ...
        <input type="text" hidden="" id="students_student_no" value="<?php echo $_POST['students_student_no']; ?>" name="students_student_no">
         ...
         <input type="text" hidden="" name="settings_id" value="<?php echo$_GET['id']; ?>">
