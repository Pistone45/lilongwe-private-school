...
if(isset($_POST['submit'])){
  ...
  $date_joined = $_POST['date_joined'];
	...
	$addLibrarian->addLibrarian($firstname,$middlename,$lastname,$phone,$address,$email,$qualifications,$date_joined);
...
<head>
  ...
  <title>Add Librarian | Lilongwe Private School</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="a#">Librarian Registration</a></li>
	...
	<!-- form start -->
            <form role="form" action="add-librarian.php" method="POST">
			<?php
                            if(isset($_SESSION["librarian-added"]) && $_SESSION["librarian-added"]==true)
                            {
                                echo "<div class='alert alert-success'>";
                                echo "<button type='button' class='close' data-dismiss='alert'>*</button>";
                                echo "<strong>Success! </strong>"; echo "You have successfully added a Librarian";
                                unset($_SESSION["librarian-added"]);
                                echo "</div>";
