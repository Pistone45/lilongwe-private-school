      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="box-header with-border">
              <a href="add-guardian.php"><button type="submit" class="btn btn-primary">Add Guardian Details</button></a>
            </div>
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				if(isset($guardians) && count($guardians)>0){
				  ...
				  <td><a href="add-student.php?id=<?php echo $guardian['id']; ?>"><i class="fa fa-edit"></i> Add Student</a></td>
                </tr>
					<?php
